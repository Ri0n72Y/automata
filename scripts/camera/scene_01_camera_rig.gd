...
signal view_direction_changed(direction: ViewDirection)
...
var _view_direction: ViewDirection = ViewDirection.SOUTHEAST
...
func set_view_direction(direction: ViewDirection) -> bool:
...
func get_view_direction() -> ViewDirection:
...
func _get_horizontal_signs(direction: ViewDirection) -> Vector2:
	match direction:
