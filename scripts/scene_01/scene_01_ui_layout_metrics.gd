...
const LEFT_STATUS_HEIGHT := 232.0
const LEFT_AUX_TOP := CONTENT_TOP + LEFT_STATUS_HEIGHT + PANEL_GAP
const TUTORIAL_TARGET_HEIGHT := 260.0

const LEFT_NARROW_WIDTH := 340.0
const LEFT_COMPACT_WIDTH := 360.0
const LEFT_WIDE_WIDTH := 380.0
