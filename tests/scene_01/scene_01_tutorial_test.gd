...
func _bind_scene() -> void:
	...
	goal_label = scene.get_node_or_null("HUDRoot/RootControl/SidebarPanel/Margin/Sidebar/TutorialSection/TutorialBody/GoalLabel") as Label
	next_button = scene.get_node_or_null("HUDRoot/RootControl/SidebarPanel/Margin/Sidebar/TutorialSection/TutorialBody/ButtonRow/NextButton") as Button
