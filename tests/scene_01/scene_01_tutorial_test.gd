...
func _bind_scene() -> void:
	...
	goal_label = scene.get_node_or_null("HUDRoot/RootControl/SidebarPanel/Margin/Sidebar/TutorialSection/TutorialBody/Margin/VBox/GoalLabel") as Label
	next_button = scene.get_node_or_null("HUDRoot/RootControl/SidebarPanel/Margin/Sidebar/TutorialSection/TutorialBody/Margin/VBox/ButtonRow/NextButton") as Button
