...
func _run() -> void:
	...
	test.expect_true(selection != null and move_controller != null, "HUD test requires command controllers.")
	test.expect_true(manager != null and object_manager != null, "HUD test requires domain owners.")
	if hud == null or selection == null or move_controller == null or manager == null or object_manager == null:
